...
namespace eShopSolution.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<EShopDbContext>(options
                => options.UseSqlServer(
                    Configuration.GetConnectionString(
                        SystemConstants.MainConnectionString)));
            ...
            services.AddTransient<IPublicProductService, 
                PublicProductService>();
            services.AddTransient<IManageProductService,
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        Title = "Swagger for eShopSolution",
                        Version = "v1"
                    });
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    Description = @"JWT Authorization header 
                                    ...
                                    your token in the test input below.
            ...
            byte[] siginKeyBytes = System.Text.Encoding.UTF8
                                                        .GetBytes(siginKey);
            ...
            services.AddAuthentication(opt =>
            {
                ...
                .AddJwtBearer(options =>
                {
                    ...
                    = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey
                            = new SymmetricSecurityKey(siginKeyBytes)
                    };
                });
